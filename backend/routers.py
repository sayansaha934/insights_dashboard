...
@insights_router.get("/customers/{customer_id}/profile")
...
@insights_router.get("/products/{product_id}/profile")
...
@insights_router.get("/insights/anomalous_customers")
def get_anomalous_customers():
    return InsightService().detect_anomalous_customers()


@insights_router.get("/insights/trending_products")
